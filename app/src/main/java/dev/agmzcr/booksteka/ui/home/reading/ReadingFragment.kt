...
import dev.agmzcr.booksteka.databinding.FragmentReadingBinding
import dev.agmzcr.booksteka.ui.MainViewModel
import dev.agmzcr.booksteka.ui.home.HomeFragmentDirections

@AndroidEntryPoint
class ReadingFragment : Fragment(), ReadingListAdapter.OnClickListener {

    private lateinit var binding: FragmentReadingBinding
    private val readingViewModel: MainViewModel by activityViewModels()
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            layoutInflater, R.layout.fragment_reading, container, false
        )
        binding.apply {
        ...
        readingViewModel.readingData.observe(viewLifecycleOwner, {
    ...
    override fun onResume() {
        super.onResume()
        readingViewModel.getWishAndReadingList()
    }

    private fun initRecylerView() {
        adapter = ReadingListAdapter(this)
    ...
    private fun initTouchHelper() {
        val itemTouchHelperCallback = object : ItemTouchHelper.SimpleCallback(
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                readingViewModel.deleteManga(manga.manga_Id!!)
                view?.let {
    ...
    override fun onReadClick(manga: MangaEntity) {
        ...
        //book.books.id?.let { readingViewModel.updateToRead(it) }
        adapter.notifyDataSetChanged()
    }

    override fun onOneMore(manga: MangaEntity) {
        manga.manga_Id?.let { readingViewModel.addOneMore(it, manga.volumesRead!! + 1) }
        readingViewModel.getWishAndReadingList()
    }

    override fun onBookClick(manga: MangaEntity) {
        val action = HomeFragmentDirections.actionReadingToDetails(
